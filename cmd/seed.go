...
func seedAuthors() []uint {
	...
	for _, v := range authors {
		...
		author, err := authorService.FindAuthors(filter, page)
		if err != nil {
			panic(err)
		}
...
func seedArticles(authorIds []uint) {
	...
	articles := []entity.Article{
		...
		},
		{
			...
			Content:      `WELLINGTON, New Zealand -- New Zealand Prime Minister Jacinda Ardern said Monday she has tested negative for the coronavirus after coming into close contact with an infected person on a commercial flight. Ardern had been isolating since late Saturday after the Jan. 22 exposure first came to light. She intends to continuing isolating through Tuesday to complete a 10-day health requirement. She has had no symptoms. The exposure occurred on a flight from the town of Kerikeri to New Zealand's largest city, Auckland. Health officials listed a dozen flights as exposure events late Saturday, possibly indicating infections among flight crews. Ardern and Governor-General Cindy Kiro, who is also isolating while awaiting a second test, were in the Northland region to do some filming ahead of New Zealand’s national day, Waitangi Day, on Feb. 6. New Zealand has managed to stamp out or contain the virus for much of the pandemic, and has reported just 52 virus deaths among its population of 5 million. But an outbreak of the omicron variant is starting to take hold and is expected to rapidly grow over the coming weeks. About 77% of New Zealanders are fully vaccinated, according to Our World in Data. That figure rises to 93% of those aged 12 and over, according to New Zealand officials. Ardern's isolation comes as Parliament is on summer break. She will chair a Cabinet meeting remotely on Tuesday.`,
		...
		},
		{
			...
			Body: `<p>ASEAN carries a strategic vision using a pluralistic and flexible approach to problem-solving with always a staunch reference to the rule of law.</
			p><p>For France, a country in search of a better balanced multi-polar world, Asean is an essential organisation, central in Asia as well as central across the Indo-Pacific.</p><p>This was said by Ambassador-Designate of France to Brunei Bernard Regnauld-Fabre during his talk on “The French and European Union visions for Asean and Indo-Pacific” during the Business Talk “The Road Towards Post 2025 Asean Community”.</p><p>He said Asean is a very important organisation to the European Union.</p><p>“EU has invested a lot in its bilateral relations with Asean from 2014 to 2020, €800mil (RM3.7bil) have been mobilised within the framework of Team Europe with a special focus in a programme to fight Covid-19,” he added.</p>`,
			Content:      `ASEAN carries a strategic vision using a pluralistic and flexible approach to problem-solving with always a staunch reference to the rule of law. For France, a country in search of a better balanced multi-polar world, Asean is an essential organisation, central in Asia as well as central across the Indo-Pacific. This was said by Ambassador-Designate of France to Brunei Bernard Regnauld-Fabre during his talk on “The French and European Union visions for Asean and Indo-Pacific” during the Business Talk “The Road Towards Post 2025 Asean Community”. He said Asean is a very important organisation to the European Union. “EU has invested a lot in its bilateral relations with Asean from 2014 to 2020, €800mil (RM3.7bil) have been mobilised within the framework of Team Europe with a special focus in a programme to fight Covid-19,” he added.`,
